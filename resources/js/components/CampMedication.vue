  ...
  <div>
    <div v-for="(familyMember, index) in familyMemberHtml" class="mt-4 mb-4">
      <div
        ...
        "
        id="familyMembers"
        class="bg-gray-100 p-4 family-member rounded-lg"
      >
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              <div v-for="item in familyMember.inputFields" class="col-md-3">
          ...
          <div class="col-md-6" v-if="familyMember.type == 'adult'"></div>
        </div>
      </div>
    </div>
    <div class="row">
