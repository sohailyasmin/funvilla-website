(function ($) {
    ...
    $("#dropdownContainer, #custom-dropdown-menu").mouseenter(function () {
        const dropdownContainer = document.getElementById("custom-dropdown-menu");
        dropdownContainer.classList.remove("hidden");
        dropdownContainer.style = "position: absolute; margin-top: 30px;";
        const notificationDropdownContainer = document.getElementById("custom-notification-dropdown-menu");
        notificationDropdownContainer.classList.add("hidden");
    });

    $(" #custom-dropdown-menu").mouseleave(function () {
        const dropdownContainer = document.getElementById("custom-dropdown-menu");
        dropdownContainer.classList.add("hidden");
        dropdownContainer.style = "";
    });

    $(".notificationDropdownContainer").click(function () {
        const notificationDropdownContainer = document.getElementById("custom-notification-dropdown-menu");
        notificationDropdownContainer.classList.remove("hidden");
        notificationDropdownContainer.style.setProperty("min-height", "250px");
        notificationDropdownContainer.style.setProperty("max-height", "300px");
        notificationDropdownContainer.style.setProperty("overflow-y", "auto");

        const dropdownContainer = document.getElementById("custom-dropdown-menu");
        dropdownContainer.classList.add("hidden");
    });

    $(".notificationDropdownContainer").mouseenter(function () {
        const dropdownContainer = document.getElementById("custom-dropdown-menu");
        dropdownContainer.classList.add("hidden");
    });

    $(" #custom-notification-dropdown-menu").mouseleave(function () {
        const dropdownContainer = document.getElementById("custom-notification-dropdown-menu");
        dropdownContainer.classList.add("hidden");
        dropdownContainer.style = "";
    });
})(jQuery);
