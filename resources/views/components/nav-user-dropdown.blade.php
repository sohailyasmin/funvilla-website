<div class="md:block hidden w-full leading-0 relative" id="dropdownContainer">
    <button class="text-slate-800 dark:text-white focus:ring-0 focus:outline-none font-medium rounded-lg text-sm text-center dropdown-toggle
    ...
    <div class="dropdown-menu z-10 hidden bg-white divide-y divide-slate-100 shadow w-44 dark:bg-slate-800 border dark:border-slate-700 !top-[23px] rounded-md
        overflow-hidden" id="custom-dropdown-menu">
