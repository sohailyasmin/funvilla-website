        ...
        <div class="flex-col sm:flex items-center justify-center relative py-8 sm:py-10 lg:py-0">
            <div class="w-full px-4 sm:px-0 sm:w-[450px]">
                <div class="text-center">
                    ...
                    <a href="{{ config('app.is_api_project') ? config('app.frontend_url') : route('login') }}" class="inline-block w-full bg-slate-900 hover:bg-gray-800 transition-all duration-500 text-white py-3 px-3 text-base font-medium rounded-md sm:mt-8 mt-8">
                        {{ __('Go back') }}
                    </a>
                </div>
            </div>
