<x-app-layout>
    <div>
        ...
        <form method="POST" action="{{ route('categories.store') }}"  class="max-w-none mx-auto xl:w-full lg:max-w-none px-2 lg:px-10 xl:px-12">
            @csrf
                ...
                <div class="grid sm:grid-cols-1 gap-x-8 gap-y-4">
                    ...
                    <div class="input-area">
                        ...
                        <textarea rows="4" name="description" id="description" class="form-control resize-none"
                            placeholder="{{ __('Enter Category Description') }}" value="{{ old('description') }}" required>
                        </textarea>
