...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = collect([
            ...
            // ['name' => 'location index', 'module_name' => 'location'],
            // ['name' => 'location create', 'module_name' => 'location'],
            // ['name' => 'location update', 'module_name' => 'location'],
            // ['name' => 'location delete', 'module_name' => 'location'],
            // ['name' => 'location show', 'module_name' => 'location'],
